...
#    max_pixel = 448
    ...
    input_width = int(input_width / 20 + round(input_width % 20 / 20)) * 20
    input_height = int(input_height / 20 + round(input_height % 20 / 20)) * 20
#    print("w=%d h=%d" % (input_width,input_height))
